...
:::caution
Agent Express is at v0.1.0. The API may change before 1.0.
:::
...
```bash
npx create-agent-express "research agent that summarizes papers"
```

This uses an AI-powered scaffold to generate a project tailored to your description. For offline use, pick from four built-in templates:
