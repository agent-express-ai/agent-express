...
- [Middleware reference](https://agent-express.ai/reference/middleware/) — all 6 namespaces documented
- [GitHub repository](https://github.com/vvkuz/agent-express) — star, fork, contribute
