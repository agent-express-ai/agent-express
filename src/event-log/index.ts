 ...
 * - `mergeVocabularies` / `validateEmit` — vocabulary merging and runtime validation.
 * - `deriveHistory` — pure projection of events into a `Message[]` view.
 * - `typedEvents` — narrowing helper for read-site type safety.
 * - Core vocabulary tables: emitted, reserved-emitted, reserved-only.
 */
...
export { mergeVocabularies, validateEmit } from "./validate.js"
export { deriveHistory } from "./derive-history.js"
export {
  CORE_EVENT_VOCABULARY,
  CORE_EVENT_TYPES,
  EMITTED_CORE_EVENTS,
